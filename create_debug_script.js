...
// Tạo một script inject vào frontend để theo dõi errors
const debugScript = `
(function() {
...
// Ghi script vào file để có thể inject
fs.writeFileSync(path.join(__dirname, 'frontend_debug.js'), debugScript);
console.log('✅ Debug script created!');
console.log('📝 Copy và paste nội dung này vào console của browser:');

console.log('\n' + '='.repeat(50));
console.log(debugScript);
console.log('='.repeat(50));

console.log('\n🔧 Sau khi paste vào console, bạn sẽ:');
console.log('1. Thấy tất cả wishlist errors được log chi tiết');
console.log('2. Có nút "🔍 Debug Errors" góc trên phải để xem lỗi');
console.log('3. Tất cả network requests được theo dõi');
console.log('\n💡 Sau đó click vào heart icon và xem console!');
